...
var Controller = /*#__PURE__*/function () {
  ...
  _createClass(Controller, [{
    ...
    value: function bindEventListeners() {
      ...
      this.viewRenderer.tableElement.on('dragover', function (event) {
        var coords = jquery__WEBPACK_IMPORTED_MODULE_1___default()(event.target).data("coords");

        _this.makeWall(coords.x, coords.y);
      });
      this.viewRenderer.tableElement.on('click', function (event) {
        var coords = jquery__WEBPACK_IMPORTED_MODULE_1___default()(event.target).data("coords");

        _this.makeWall(coords.x, coords.y);
      });
      this.viewRenderer.tableElement.on('dragstart', function (event) {
        var coords = jquery__WEBPACK_IMPORTED_MODULE_1___default()(event.target).data("coords");
  ...
  _createClass(ViewRenderer, [{
    ...
    value: function renderGrid() {
      ...
      var td = function td(y, x) {
        var tdElement = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<td draggable='true'></td>");
